...
*********************************************************************************************************
*/
#define USE_SPI_DMA      /* DMA方式 最低延迟25us */
...
#define SPIx_TX_DMA_STREAM          DMA2_Stream2
...
#define SPIx_DMA_TX_IRQn            DMA2_Stream2_IRQn
#define SPIx_DMA_RX_IRQn            DMA2_Stream0_IRQn
#define SPIx_DMA_TX_IRQHandler      DMA2_Stream2_IRQHandler
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *_hspi)
{
	...
	#ifdef USE_SPI_DMA
	{
		...
		hdma_tx.Init.Mode                = DMA_NORMAL;              /* 正常模式:DMA_NORMAL  循环模式：DMA_CIRCULAR*/
		...
		hdma_rx.Init.Mode                = DMA_NORMAL;             /* 正常模式:DMA_NORMAL  循环模式：DMA_CIRCULAR*/
